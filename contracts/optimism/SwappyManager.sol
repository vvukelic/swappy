...
contract SwappyManager is AccessControl, ReentrancyGuard {
    ...
    address constant private _wethAddress = 0x4200000000000000000000000000000000000006;
    ...
    constructor(address dataContractAddress, address payable feeAddress) {
        ...
        _priceFeed = AggregatorV3Interface(0x13e3Ee699D1909E989722E753853AE30b17e08c5);
    }
