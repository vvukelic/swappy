...
contract SwappyManager is AccessControl, ReentrancyGuard {
    ...
    address constant private _wethAddress = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    ...
    constructor(address dataContractAddress, address payable feeAddress) {
        ...
        _priceFeed = AggregatorV3Interface(0x639Fe6ab55C921f74e7fac1ee960C0B6293ba612);
    }
